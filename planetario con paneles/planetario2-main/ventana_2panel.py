...
lblimagen2 = Label(frame3, image=imagenL3)
lblimagen2.place(x=0, y=0)
button2 = Button(frame2, text="Acción Panel 3", command=button_action_panel2)
button2.place(x=10, y=10)  # Ubicado en la esquina superior izquierda del Panel 2
switch_button2 = Button(frame2, text="Ir a Panel 1", command=lambda: show_frame(frame1))
switch_button2.place(x=950, y=680)  # Ubicado en la esquina inferior derecha del Panel 2

# Panel 4 con la cuarta imagen y botones
lblimagen2 = Label(frame4, image=imagenL4)
lblimagen2.place(x=0, y=0)
button2 = Button(frame2, text="Acción Panel 3", command=button_action_panel2)
button2.place(x=10, y=10)  # Ubicado en la esquina superior izquierda del Panel 2
switch_button2 = Button(frame2, text="Ir a Panel 1", command=lambda: show_frame(frame1))
...
Planetas.add_command(label="P1", command=lambda:show_frame(frame2))
Planetas.add_command(label="P2", command=lambda:show_frame(frame3))
Planetas.add_command(label="P4", command=lambda:show_frame(frame4))
